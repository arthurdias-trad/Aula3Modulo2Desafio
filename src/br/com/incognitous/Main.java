...
public class Main {
	...
	public static void main(String[] args) {
		FuncionarioPF funcionario = new FuncionarioPF("Rua das Palmeiras", "José Silva", "123456789", "jose@email.com", "Manutenção", LocalDate.of(2018, 1, 1), 1500.00f, "123456789123");
